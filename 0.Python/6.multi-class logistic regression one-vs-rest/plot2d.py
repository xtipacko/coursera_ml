...
import numpy as np
import csv
from datapoints import labeled_three_classPoints, set_seed
...
if __name__ == '__main__':
    plot = Plot2D((10,10))
    set_seed(144)
    datapoints = labeled_three_classPoints(Aweight=5, Bweight=3, Cweight=2, Aamount=500, Bamount=500, Camount=500, scale=10)
